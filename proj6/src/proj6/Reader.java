...
public class Reader extends JFrame{
	...
	public Reader(String s){ //метод названный также как класс - конструктор
		super(s);//обращение к супер классу
		setLayout(new FlowLayout()); //расположение объектов в фрейме построчно
